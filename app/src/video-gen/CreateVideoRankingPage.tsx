...
export const CreateVideoRankingPage = () => {
      ...
      <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow border border-gray-100 dark:border-gray-700">
        <div className="mb-6">
          ...
          <input
            ...
            placeholder="Top 10 Fastest Cars"
          />
        </div>
        <div className="mb-6">
          <label className="block text-sm font-medium mb-2">Ranking Topic</label>
          <textarea
            rows={5}
            value={topic}
            onChange={(e) => setTopic(e.target.value)}
            className="w-full p-3 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700"
            placeholder="Provide a list of items to rank or ask AI to generate..."
          ></textarea>
        </div>
        <button
