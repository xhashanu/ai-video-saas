...
export const CreateAutoClippingPage = () => {
  ...
  return (
    <SidebarLayout><div className="p-8 max-w-4xl mx-auto dark:bg-gray-900 text-gray-900 dark:text-gray-100 min-h-screen">
      <h1 className="text-3xl font-bold mb-8">Create Auto Clipping</h1>
      <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow border border-gray-100 dark:border-gray-700">
        <div className="mb-6">
          ...
          <input
            ...
            placeholder="My Podcast Shorts"
          />
        </div>
        <div className="mb-6">
          <label className="block text-sm font-medium mb-2">Long-form Video URL</label>
          <input
            type="text"
            value={videoUrl}
          ...
          />
          <p className="text-xs text-gray-500 mt-2">Our AI will automatically find the best highlights and convert them into shorts.</p>
        </div>
        <button
